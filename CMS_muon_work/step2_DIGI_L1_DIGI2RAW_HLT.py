...
# with command line options: step2 --conditions auto:phase1_2017_cosmics -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2017 --scenario cosmics -n 2000 --datatier GEN-SIM-DIGI-RAW --era Run2_2017 --eventcontent FEVTDEBUG --filein file:step1.root --fileout file:step2.root
