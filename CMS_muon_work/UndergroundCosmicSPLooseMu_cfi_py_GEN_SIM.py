...
# with command line options: UndergroundCosmicSPLooseMu_cfi.py --conditions auto:phase1_2017_cosmics -s GEN,SIM -n 2000 --era Run2_2017 --eventcontent FEVTDEBUG --relval 5000000,500000 --scenario cosmics --datatier GEN-SIM --beamspot Realistic50ns13TeVCollision --fileout file:step1.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('UndergroundCosmicSPLooseMu_cfi.py nevts:2000'),
